...
- [[Per-Subject Utility Scatter Plot on vFinal Poster (3535 above diagonal)]] - `references` [EXTRACTED]
- [[Poster Board V7 (Audit-Clean, CSEF 2026)]] - `implements` [INFERRED]
- [[System Architecture Flowchart on vFinal Poster (EEGNet→TCN→Controller→Audio)]] - `references` [EXTRACTED]
