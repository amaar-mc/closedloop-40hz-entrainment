...
- [[Calling process_window() twice with the same input produces different     PAC-st]] - `uses` [INFERRED]
- [[Compute spectral features from sequential 2-second EEG windows.      Uses causal]] - `rationale_for` [EXTRACTED]
...
- [[Ensure filtfilt is not imported or used anywhere in srcstreaming.     This is]] - `uses` [INFERRED]
...
- [[Parity verification StreamingFeatureExtractor vs offline extract_spectral_featu]] - `uses` [INFERRED]
- [[Passing (3, 500) to a 4-channel extractor raises an assertion or ValueError.]] - `uses` [INFERRED]
...
- [[Return (n_windows, n_channels, 500) synthetic EEG windows.]] - `uses` [INFERRED]
- [[Return dict of feature slice indices by component.]] - `uses` [INFERRED]
