...
- [[Loads enhanced multiscale NPZ and computes per-subject causal smoothed targets.]] - `uses` [INFERRED]
...
- [[_make_causal_mask()]] - `method` [EXTRACTED]
- [[count_parameters()_5]] - `method` [EXTRACTED]
- [[forward()_9]] - `method` [EXTRACTED]
- [[freeze_backbone()]] - `method` [EXTRACTED]
- [[improved_tcn_model.py]] - `contains` [EXTRACTED]
- [[unfreeze_all()]] - `method` [EXTRACTED]
