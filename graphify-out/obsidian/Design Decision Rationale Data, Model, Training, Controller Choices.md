...
- [[Rationale GroupNorm Used in TCN for Stable Cross-Subject Statistics]] - `references` [EXTRACTED]
- [[Rationale Raw Targets (ts=1) Over Smoothed (ts=5) for Honest Evaluation]] - `references` [EXTRACTED]
