...
- [[CausalConv1dBlock (Dilated Residual Conv Block)]] - code - scripts/pipeline/run_tribe_tcn_validation.py
- [[Closed-loop controller using TCN-TRIBE for proactive decisions.]] - rationale - scripts/pipeline/run_tribe_tcn_validation.py
- [[FixedScheduleCtrl_4]] - code - scripts/pipeline/run_tribe_tcn_validation.py
- [[Generate PAC time series from TRIBE V2 simulator with realistic noise.      Uses]] - rationale - scripts/pipeline/run_tribe_tcn_validation.py
- [[Lightweight causal TCN for TRIBE simulator PAC forecasting.]] - rationale - scripts/pipeline/run_tribe_tcn_validation.py
- [[Oracle two-pass — collect PAC, then decide with perfect info.]] - rationale - scripts/pipeline/run_tribe_tcn_validation.py
- [[Rationale Domain Mismatch Between Real EEG TCN and TRIBE Simulator]] - code - scripts/pipeline/run_tribe_tcn_validation.py
- [[ReactiveCtrl_4]] - code - scripts/pipeline/run_tribe_tcn_validation.py
- [[Run one trial with a controller on the realistic-noise simulator.]] - rationale - scripts/pipeline/run_tribe_tcn_validation.py
- [[Same alignment metrics as the real-data validation.]] - rationale - scripts/pipeline/run_tribe_tcn_validation.py
- [[Single causal dilated conv block with residual.]] - rationale - scripts/pipeline/run_tribe_tcn_validation.py
- [[TCNTribe]] - code - scripts/pipeline/run_tribe_tcn_validation.py
- [[TCNTribe Model (TRIBE-trained Causal TCN)]] - code - scripts/pipeline/run_tribe_tcn_validation.py
- [[TCNTribeController]] - code - scripts/pipeline/run_tribe_tcn_validation.py
- [[TCNTribeController (Proactive Closed-Loop Controller)]] - code - scripts/pipeline/run_tribe_tcn_validation.py
...
```dataview
TABLE source_file, type FROM #community/TRIBE-TCN_Validation
SORT file.name ASC
```
