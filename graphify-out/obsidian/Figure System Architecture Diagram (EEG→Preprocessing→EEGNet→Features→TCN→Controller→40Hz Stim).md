---
source_file: "submission/paper/figures/system_block_diagram.pdf"
type: "image"
...
# Figure: System Architecture Diagram (EEG→Preprocessing→EEGNet→Features→TCN→Controller→40Hz Stim)
