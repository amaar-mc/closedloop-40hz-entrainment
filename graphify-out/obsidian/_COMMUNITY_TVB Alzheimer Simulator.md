...
- [[FixedScheduleCtrl_2]] - code - scripts/pipeline/run_tvb_alignment.py
- [[Get current simulator state._2]] - rationale - src/tribe_v2/tvb_simulator.py
- [[Get full simulation history.          Returns dict with same keys as Entrainment]] - rationale - src/tribe_v2/tvb_simulator.py
- [[Get the per-region A (excitatory gain) array.]] - rationale - src/tribe_v2/tvb_simulator.py
- [[Get unscaled raw MI values for diagnostics.]] - rationale - src/tribe_v2/tvb_simulator.py
- [[Initialize TVB Alzheimer simulator.          Args             severity Disease]] - rationale - src/tribe_v2/tvb_simulator.py
- [[JRDiseaseProfile]] - code - src/tribe_v2/tvb_simulator.py
- [[Jansen-Rit parameter modifications for Alzheimer's disease.      A (excitatory g]] - rationale - src/tribe_v2/tvb_simulator.py
- [[Load and configure the TVB 76-region connectome.]] - rationale - src/tribe_v2/tvb_simulator.py
- [[ReactiveCtrl_2]] - code - scripts/pipeline/run_tvb_alignment.py
- [[Reset simulator to initial state.          Args             initial_pac Overri]] - rationale - src/tribe_v2/tvb_simulator.py
- [[Run a TVB simulation chunk and return EEG proxy signal.          Args]] - rationale - src/tribe_v2/tvb_simulator.py
- [[Run initial warmup to let TVB settle from transients.]] - rationale - src/tribe_v2/tvb_simulator.py
- [[Simulate one time step of neural dynamics.          Runs a TVB Jansen-Rit simula]] - rationale - src/tribe_v2/tvb_simulator.py
- [[TVB Jansen-Rit Alignment Evaluation Closed-Loop Controller Comparison  Runs Fix]] - rationale - scripts/pipeline/run_tvb_alignment.py
- [[TVB-Based Alzheimer's Disease Simulator for Closed-Loop 40Hz Entrainment  Uses T]] - rationale - src/tribe_v2/tvb_simulator.py
...
```dataview
TABLE source_file, type FROM #community/TVB_Alzheimer_Simulator
SORT file.name ASC
```
