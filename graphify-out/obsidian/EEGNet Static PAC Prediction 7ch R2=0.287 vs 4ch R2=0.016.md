...
# EEGNet Static PAC Prediction: 7ch R2=0.287 vs 4ch R2=0.016

## Connections

- [[4-Channel vs 7-Channel EEG Performance Gap Report]] - `references` [EXTRACTED]
- [[CSEF Defense Narrative Temporal Context Compensates for Spatial Reduction]] - `references` [EXTRACTED]
- [[MultiscaleCausalTCN Model Performance (73-feature, 31K params)]] - `semantically_similar_to` [INFERRED]
