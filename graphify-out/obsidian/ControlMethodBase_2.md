...
- [[FixedScheduleControl_7]] - `inherits` [EXTRACTED]
- [[OracleControl_6]] - `inherits` [EXTRACTED]
- [[PredictiveLookAheadControl_6]] - `inherits` [EXTRACTED]
- [[ReactiveThresholdControl_6]] - `inherits` [EXTRACTED]
