---
source_file: "archive/experimental/run_best_combo.py"
type: "rationale"
...
# Best combination experiments: 1. Target smoothing (ts=5) + deep TCN architecture
...
- [[run_best_combo.py]] - `rationale_for` [EXTRACTED]
