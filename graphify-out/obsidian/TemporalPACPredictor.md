...
- [[Evaluate model and return metrics in original scale.]] - `uses` [INFERRED]
- [[Evaluate model on a data split.      Returns metrics in ORIGINAL PAC scale (de]] - `uses` [INFERRED]
- [[Full training pipeline for temporal PAC prediction.]] - `uses` [INFERRED]
- [[LSTM-based temporal predictor for future PAC values.      Takes a sequence of]] - `rationale_for` [EXTRACTED]
- [[LongWindowTemporalDataset]] - `uses` [INFERRED]
- [[Temporal dataset for 8-second windows with 4-second hop.      With 4-second ho]] - `uses` [INFERRED]
- [[Train for one epoch. Returns average loss.]] - `uses` [INFERRED]
