...
- [[Large EEGNet with ~141K parameters for capacity ceiling experiments.      Key]] - `rationale_for` [EXTRACTED]
...
- [[forward()_38]] - `method` [EXTRACTED]
- [[get_feature_maps()_1]] - `method` [EXTRACTED]
