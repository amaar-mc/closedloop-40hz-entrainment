...
- [[Count trainable parameters.]] - rationale - archive/experimental_models/eegnet_v2.py
- [[EEGDatasetV2]] - code - archive/experimental_models/data_loader_v2.py
- [[EEGNetV2]] - code - archive/experimental_models/eegnet_v2.py
- [[Enhanced Data Loader for ΔPAC Prediction (Version 2)  Key improvements over v1]] - rationale - archive/experimental_models/data_loader_v2.py
- [[Enhanced EEGNet Architecture for ΔPAC Prediction (Version 2)  Key improvements]] - rationale - archive/experimental_models/eegnet_v2.py
- [[Enhanced EEGNet for ΔPAC regression with improved capacity.      Changes from]] - rationale - archive/experimental_models/eegnet_v2.py
- [[Enhanced Training Script for EEGNetV2 (Version 2)  Key improvements over v1]] - rationale - archive/experimental_models/training_v2.py
- [[Enhanced trainer for EEGNetV2 with improved training strategies.]] - rationale - archive/experimental_models/training_v2.py
- [[Forward pass.          Args             x Input EEG tensor (batch, 1, n_cha]] - rationale - archive/experimental_models/eegnet_v2.py
- [[Load preprocessed data and compute ΔPAC labels.      Args         data_dir]] - rationale - archive/experimental_models/data_loader_v2.py
- [[Main training script.]] - rationale - archive/experimental_models/training_v2.py
- [[ModelTrainerV2]] - code - archive/experimental_models/training_v2.py
- [[PyTorch Dataset for EEG windows with ΔPAC labels.      Changes from v1     -]] - rationale - archive/experimental_models/data_loader_v2.py
- [[Test enhanced EEGNet.]] - rationale - archive/experimental_models/eegnet_v2.py
...
```dataview
TABLE source_file, type FROM #community/Archived_EEGNet_V2
SORT file.name ASC
```
