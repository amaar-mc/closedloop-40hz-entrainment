...
- [[NeuroCare 40Hz -- Live Mission Control v5  Uses st.empty() placeholders for flic]] - rationale - apps/neurocare_live.py
- [[Pure-numpy fallback when brainflow is not installed (e.g. cloud deploy).      Ge]] - rationale - src/streaming/adapters.py
- [[RealEEGAdapter]] - code - src/streaming/adapters.py
...
- [[_fig_bands()]] - code - apps/neurocare_live.py
- [[_fig_eeg()]] - code - apps/neurocare_live.py
- [[_fig_stim()]] - code - apps/neurocare_live.py
- [[_fig_sync()]] - code - apps/neurocare_live.py
- [[_fig_z()]] - code - apps/neurocare_live.py
- [[_load()_1]] - code - apps/neurocare_live.py
- [[_pac_disp()]] - code - apps/neurocare_live.py
- [[_pred_disp()]] - code - apps/neurocare_live.py
