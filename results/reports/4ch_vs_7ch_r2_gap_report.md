...
The TCN predicts future PAC from a 20-second temporal history of spectral features. Temporal context partially compensates for reduced spatial coverage because PAC trajectory patterns -- including stim_state transitions, timing within stimulus/rest blocks, and spectral trend dynamics -- carry predictive information that survives channel reduction. The model learns _when_ PAC will change from the sequence of recent states, which is less dependent on how many electrodes measure it.
