...
4. *"Feature Extraction (12 PAC+Stim features)" →*
5. *"Causal TCN (5,154 params)" → "Predicted PAC (5s ahead)" →*
...
*Line graph. X-axis: Prediction Horizon (1, 3, 5, 8, 10 seconds). Y-axis: R².*
*Lines for 7ch (solid) and 4ch (dashed):*
...
*Version 6 — Updated for CSEF judging (April 2026). Reflects PAC+Stim feature discovery: 12 features replace 73, R² improves from −0.025 to 0.606 mean. Controller comparison numbers unchanged from V5. All numerical claims verified against source data files.*
