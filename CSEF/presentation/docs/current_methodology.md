...
*Note: The initial design used 73 features (61 spectral + 7 PAC-derived + 5 stim context). A feature ablation study (March 2026) found the 61 spectral features caused cross-subject overfitting, reducing test R² from 0.558 to -0.025. Dropping them raises test R² to 0.606 ± 0.032.*
