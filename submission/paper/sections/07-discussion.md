...
The offline replay method cannot model this interaction — it can only assess whether the controller's decisions _would have been_ aligned with the brain's natural PAC trajectory absent any stimulation effect.
