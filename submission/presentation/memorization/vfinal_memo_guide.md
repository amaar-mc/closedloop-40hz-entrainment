...
_Memory trick:_ Years count up — **2016 → 2024 → 2025**. Disease and reduction are round numbers.
...
_Memory trick:_ "35 patients, 7 channels, 250 Hz" — say it like a rhythm.
...
_Memory trick:_ "Gamma locked to theta." One phrase. Always the same.
...
_Memory trick:_ "1,500 to 2 million, all equal 0.287."
...
_Memory trick:_ "73 minus 61 leaves 12. Negative zero to point six."
...
_Memory trick:_ Two pairs → "83 vs 52, 72 vs 64." Two g's → "4.47 and 1.31." Three closers → "91% oracle, 35/35, 6 test."
...
_Memory trick:_ "$249 headset, 4 electrodes, 50ms, $300."
