# Memorization Map: 3 to 4 Minute Board Walk

This map is tied to the actual poster layout.

Do not memorize paragraphs. Memorize locations and one job per location.
...
Use these exact transitions if you want cleaner flow:
...
- "This was also consistent at the patient level."
- "So the main contribution is..."
- "The main limitation is..."
- "So the next step is..."

## 12-Minute Practice Method

1. Stand up with the poster image in front of you.
2. Say only the 12 stop names once.
3. Add one sentence per stop.
4. Do one full run with hand motions.
5. Redo only stops 4 through 8. That is the core logic chain.
6. End with the one-sentence summary twice.
