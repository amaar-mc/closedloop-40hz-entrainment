...
|---------|---------------|---------|--------|---------------|
| 1s | 0.760 | 0.812 | 0.735 | -0.077 (baselines win) |
...
- **73 features** (61 spectral + 7 PAC-derived + 5 stimulation context)
- **R² = 0.25** at 5-10s horizons (vs negative R² for baselines)
- **+0.5 R² margin** over best baseline at useful horizons
