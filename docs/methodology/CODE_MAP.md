...
| File                                | Purpose                                                               | Status     | Key Class/Function                 |
| ----------------------------------- | --------------------------------------------------------------------- | ---------- | ---------------------------------- |
| `build_multiscale_dataset.py`       | Causal sequence construction (73 features, lookback=20, horizon=1-5)  | **ACTIVE** | `build_multiscale_dataset()`       |
...
| Multiscale temporal | 73 (61 spectral + 7 PAC-derived + 5 stim context) | `build_multiscale_dataset.py` | MultiscaleCausalTCN     |
