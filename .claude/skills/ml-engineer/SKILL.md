---
name: ml-engineer
description: AI/ML engineer specialist for modifying the EEG closed-loop entrainment pipeline. Use when making any change to data loading, preprocessing, model architecture, training, evaluation, or control logic. Ensures Claude deeply understands the data, existing pipeline code, and goals before writing code.
