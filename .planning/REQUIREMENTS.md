...
- [x] **CONS-02**: Reference [25] misattribution fixed (TCFormer citation corrected or removed)
- [x] **CONS-03**: Orphan references pruned — keep only references actually cited in text
...
- [x] **PROP-01**: All corrections propagated to CSEF presentation PDF
- [x] **PROP-02**: All corrections propagated to RESULTS_REPORT.md
